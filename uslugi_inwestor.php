<?php
	...
	if (!isset($_POST['zaznacz']))
		...
		mysqli_report(MYSQLI_REPORT_STRICT);
			...
			{
				$sql_inwestycje = "SELECT * FROM uslugi0 WHERE id_klient='$id_klienta' AND typ_uslugi='inwestycje' ORDER BY nazwa_uslugi";
			}

			
			$result0 = mysqli_query($polaczenie, $sql_inwestycje);
			$inwestycje = mysqli_fetch_all($result0, MYSQLI_ASSOC);
        ...
        <main>
			<table id="customers">
				<thead>
					...
					<th 
					<?php if ($_SESSION['rola']=="kredytowiec") echo 'width="31%"';?>
					>Status usługi</th>
				</thead>
...
<!-- uslugi poczatek -->
						<?php foreach ($inwestycje as $row4): ?>
						<tr>
							...
							<td>
								<?php if ($_SESSION['rola']=="kredytowiec") echo '<a href="usluga_pozytywna.php?id_z_uslug='.$id_z_uslug.'&id_klienta='.$id_klienta.'" class="button_pozytywny">Pozytywny</a>';?>
								<?php if ($row4['status'] == 'Pozytywny') {	
								...
								<?php if ($_SESSION['rola']=="kredytowiec") echo '<a href="usluga_w_toku.php?id_z_uslug='.$id_z_uslug.'&id_klienta='.$id_klienta.'" class="button_w_toku">W toku</a>';?>
								<?php if ($_SESSION['rola']=="kredytowiec") echo '<a href="usluga_negatywna.php?id_z_uslug='.$id_z_uslug.'&id_klienta='.$id_klienta.'" class="button_negatywny">Negatywny</a>';?>					
							</td>
						</tr>
