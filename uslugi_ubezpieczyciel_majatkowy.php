<?php
	...
	if (!isset($_POST['zaznacz']))
		...
		mysqli_report(MYSQLI_REPORT_STRICT);
			...
			{
				$sql_ubezpieczenia = "SELECT * FROM uslugi WHERE id_klient='$id_klienta' AND typ_uslugi='ubezpieczenie_majatkowe' ORDER BY nazwa_uslugi";
			}
        ...
        <main>
			<table id="customers">
				<thead>
					...
					<th <?php if ($_SESSION['rola']=="ubezpieczyciel_majatkowy") echo 'width="31%"';?>>Status usługi</th>
				</thead>
...
<!-- uslugi0 poczatek -->
						...
						<tr>
							...
							<td>
								<?php if ($_SESSION['rola']=="ubezpieczyciel_majatkowy") echo '<a href="usluga_pozytywna.php?id_z_uslug='.$id_z_uslug.'&id_klienta='.$id_klienta.'" class="button_pozytywny">Pozytywny</a>';?>
								<?php
								...
								<?php if ($_SESSION['rola']=="ubezpieczyciel_majatkowy") echo '<a href="usluga_w_toku.php?id_z_uslug='.$id_z_uslug.'&id_klienta='.$id_klienta.'" class="button_w_toku">W toku</a>';?>
								<?php if ($_SESSION['rola']=="ubezpieczyciel_majatkowy") echo '<a href="usluga_negatywna.php?id_z_uslug='.$id_z_uslug.'&id_klienta='.$id_klienta.'" class="button_negatywny">Negatywny</a>';?>
							</td>
						</tr>
						<?php endforeach;?>
<!-- uslugi0 koniec -->
