<?php
	...
	if (!isset($_POST['zaznacz']))
		...
		mysqli_report(MYSQLI_REPORT_STRICT);
			...
			{
				$sql_uslugi = "SELECT *  FROM uslugi WHERE id_klient='$id_klienta' ORDER BY nazwa_uslugi";
			}

			$result0 = mysqli_query($polaczenie, $sql_uslugi);
			$uslugi = mysqli_fetch_all($result0, MYSQLI_ASSOC);
        ...
        <main>
			<table id="customers">
				<thead>
					...
					<th <?php if ($_SESSION['rola']=="administrator" || $_SESSION['rola']=="sekretarka") echo 'width="31%"';?>>Status usługi</th>
				</thead>
...
<!-- uslugi poczatek -->
						...
						<tr>
							...
							<td>
								<?php if ($_SESSION['rola']=="administrator" || $_SESSION['rola']=="sekretarka") echo '<a href="usluga_pozytywna.php?id_z_uslug='.$id_z_uslug.'&id_klienta='.$id_klienta.'" class="button_pozytywny">Pozytywny</a>';?>
								<?php
