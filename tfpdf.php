...
function Output($dest='', $name='', $isUTF8=true)
{
	...
	$rezultat = $polaczenie->query("SELECT pr.id, pr.imie, pr.nazwisko, pr.email FROM pracownicy0 pr ORDER BY nazwisko ASC, imie ASC");
	...
	if($dest=='')
		$dest = 'I';
	if($name=='')
		$name = $imie . '_' . $nazwisko . '_raport_' . $rok . '.pdf';
